...
import { 
  Home, Search, Plus, PlaySquare, Heart, MessageCircle, Send, Bookmark, Repeat,
  X, Settings, Music, Type, Wand2, Image as ImageIcon, RefreshCcw, Zap, ChevronLeft, Grid, Video
} from 'lucide-react';

// ==========================================
// 1. CAMERA COMPONENT (No changes here)
// ==========================================
const CreateCameraPage = ({ onClose, onShare, isVisible }) => {
